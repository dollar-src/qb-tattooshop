...
AddEventHandler('esx:playerLoaded', function()
	isLoggedIn = true
	Citizen.Wait(300)
	ESX.TriggerServerCallback('qb-tattooshop:GetPlayerTattoos', function(tattooList)
		if tattooList then
...
function BuyTattoo(collection, name, label, price)
	ESX.TriggerServerCallback('qb-tattooshop:PurchaseTattoo', function(success)
		if success then
...
function RemoveTattoo(name, label)
	...
	TriggerEvent("You have removed the " .. GetLabelText(label) .. " tattoo", 'success')
end
